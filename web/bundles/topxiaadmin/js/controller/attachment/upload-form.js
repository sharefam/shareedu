define(function(require, exports, module) {
  ...
  exports.run = function() {
    $('.js-attachment-list').on('click', '.js-attachment-delete', function() {
      var $this = $(this);
      var attachment_remove = confirm(Translator.trans('admin.attachment.delete_confirm_message'));
      if (attachment_remove) {
        $.post($this.data('url'), function(result) {

        }).done(function(result) {
          if (result.msg == 'ok') {
            Notify.success(Translator.trans('admin.attachment.delete_success'));
            ...
            Notify.danger(Translator.trans('admin.attachment.delete_error'));
          }
