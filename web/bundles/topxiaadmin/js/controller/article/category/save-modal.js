define(function(require, exports, module) {
	...
	exports.run = function() {
		...
		var validator = new Validator({
            ...
            onFormValidated: function(error, results, $form) {
                ...
                $.post($form.attr('action'), $form.serialize(), function(html){
                    ...
                    Notify.success(Translator.trans('admin.article.category.submit_success'));
                    window.location.reload();
				}).fail(function() {
                    Notify.danger(Translator.trans('admin.article.category.submit_error'));
                });
        ...
        $modal.find('.delete-category').on('click', function() {
            if (!confirm(Translator.trans('admin.article.category.delete_confirm_message'))) {
                return ;
            }
            ...
            $.post($(this).data('url'), function(response) {
                ...
                Notify.danger(Translator.trans('admin.article.category.delete_error',{error:error.responseJSON.error.message}));
            });
