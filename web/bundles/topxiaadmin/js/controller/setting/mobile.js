      ...
      if ($('#mobile-splash1-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.splash_setting_success',{num: 1}));
          });
        });

        $("#mobile-splash1-remove").on('click', function () {
          if (!confirm(Translator.trans('admin.setting.mobile.splash.delete_confirm_message'))) return false;
          var $btn = $(this);
          $.post($btn.data('url'), function () {
            $("#mobile-splash1-container").html('');
            $form.find('[name=splash1]').val('');
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.splash.delete_success',{num: 1}));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.splash.delete_error',{num: 1}));
          });
        });
      }
      ...
      if ($('#mobile-splash2-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.splash_setting_success',{num: 2}));
          });
        });
        ...
        $("#mobile-splash2-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.splash.delete_success',{num: 2}));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.splash.delete_error',{num: 2}));
          });
        });
      }
      ...
      if ($('#mobile-splash3-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.splash_setting_success',{num: 3}));
          });
        });
        ...
        $("#mobile-splash3-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.splash.delete_success',{num: 3}));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.splash.delete_error',{num: 3}));
          });
        });
      }
      ...
      if ($('#mobile-splash4-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.splash_setting_success',{num: 4}));
          });
        });
        ...
        $("#mobile-splash4-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.splash.delete_success',{num: 4}));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.splash.delete_error',{num: 4}));
          });
        });
      }
      ...
      if ($('#mobile-splash5-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.splash_setting_success',{num: 5}));
          });
        });
        ...
        $("#mobile-splash5-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.splash.delete_success',{num: 5}));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.splash.delete_error',{num: 5}));
          });
        });
      }
      ...
      if ($('#site-applogo-upload').length) {
        ...
        uploader.on('uploadSuccess', function (file, response) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.setting.mobile.applogo_setting_success'));
          });
        });
        ...
        $("#site-applogo-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.applogo.delete_success'));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.applogo.delete_error'));
          });
        });
      }
      //
      ...
      if ($('#site-appcover-upload').length) {
        ...
        $("#site-appcover-remove").on('click', function () {
          ...
          $.post($btn.data('url'), function () {
            ...
            $btn.hide();
            Notify.success(Translator.trans('admin.setting.mobile.appcover.delete_success'));
          }).error(function () {
            Notify.danger(Translator.trans('admin.setting.mobile.appcover.delete_error'));
          });
        });
      }
    };
