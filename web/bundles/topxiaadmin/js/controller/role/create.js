define(function(require, exports, module) {
    ...
    exports.run = function() {
            ...
            onFormValidated: function(error, results, $form) {
                ...
                $.post($form.attr('action'), $form.serialize(), function(html) {
                    ...
                    if (string.indexOf('edit') >= 0) {
                        Notify.success(Translator.trans('admin.role.update_success'));
                    } else{
                        Notify.success(Translator.trans('admin.role.create_success'));
                    }
        ...
        validator.addItem({
            element: '#name',
            required: true,
            rule: 'byte_minlength{min:2} byte_maxlength{max:100} chinese_alphanumeric remote '
        });

        validator.addItem({
            element: '#code',
            required: true,
            rule: 'minlength{min:2} maxlength{max:50} alphanumeric remote'
        });
