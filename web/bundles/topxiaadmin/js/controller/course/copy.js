    ...
    exports.run = function() {
        ...
        var validator = new Validator({
                ...
                $.post($form.attr('action'), $form.serialize(), function(html) {
                    $modal.modal('hide');
                    Notify.success(Translator.trans('admin.course.copy_success'));
                    window.location.reload();
                }).error(function(){
                    Notify.danger(Translator.trans('admin.course.copy_error'));
                });
        ...
        validator.addItem({
            ...
            required: true,
            errormessageRequired: Translator.trans('admin.course.title_required_message')
        });
