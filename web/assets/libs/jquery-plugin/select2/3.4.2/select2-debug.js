define("jquery-plugin/select2/3.4.2/select2-debug", [ "$-debug", "./i18n/{locale}-debug" ], function(require) {
      ...
      AbstractSelect2 = clazz(Object, {
          ...
          init: function(opts) {
              ...
              if (this.opts.treeview) {
                  ...
                  this.results.addClass('select-result--treeview');
              }
              ...
              opts = $.extend({}, {
                  ...
                  populateResults: function(container, results, query) {
                      ...
                      if (opts.treeview) {
                          ...
                          var inputVal = self.opts.element.val();
                          if (inputVal) {
                              var inputValArray = [];
                              if (typeof inputVal == 'string') {
                                  inputValArray.push(inputVal);
                              } else {
                                  inputValArray = inputVal;
                              }

                              for (var i = 0; i < inputValArray.length; i++) {
                                  var $selectedNode = $('#select2-result-' + self.filterVal(inputValArray[i]));
          ...
          positionDropdown: function() {
              ...
              if (this.opts.dropdownAutoWidth) {
                  ...
                  $resultsListNode.each2(function() {
                      // 修改计算方式
                      //old  var thisWidth = $(this).data('indentCount') * 25 + $(this).find('.select2-result-text').text().length * 14 + 50;
                      
                      var thisWidth = $(this).outerWidth() + spaceWidth; 
