  ...
  initValidator() {
    ...
    this.validator = $form.validate({
      ...
      messages: {
        ...
        rewardPoint: {
          required: Translator.trans('course.manage.empty_course_rewardPoint_hint'),
          max: Translator.trans('course.manage.error_int_hint')
        },
        taskRewardPoint: {
          required: Translator.trans('course.manage.empty_course_task_rewardPoint_hint'),
          max: Translator.trans('course.manage.error_int_hint')
        },
      }
    });
