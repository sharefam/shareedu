...
class UserController extends BaseController
{
    ...
    public function cardShowAction(Request $request, $userId)
    {
        ...
        if (in_array('ROLE_TEACHER', $user['roles'])) {
            ...
            $teacherLevel = $this->getTeacherLevelService()->getLevel($teacherProfile['levelId']);
        }
        ...
        return $this->render('user/card-show.html.twig', array(
            ...
            'isFollowed' => $isFollowed,
            'levels' => $levels,
            'teacherLevel' => isset($teacherLevel) ? $teacherLevel : array(),
            'nowTime' => time(),
        ));
    }
    ...
    protected function saveUserInfo($request, $user)
    {
        ...
        $userInfo = ArrayToolkit::parts($formData, array(
            ...
            'quick_entrance', 'custom_column', 'textField3', 'textField4', 'textField5', 'textField6', 'textField7', 'textField8', 'textField9', 'textField10',
        ));
    ...
    protected function tryGetUser($uuid)
    {
