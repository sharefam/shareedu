    ...
    protected function buildAccessScope($fields)
    {
        switch ($fields['hireDateType']) {
            case 'greatThanOrEqual':
                $fields['accessHireDate'] = array('hireDateType' => 'greatThanOrEqual', 'days' => isset($fields['days']) ? (int)$fields['days'] : '');
                break;
            case 'lessThanOrEqual':
                $fields['accessHireDate'] = array('hireDateType' => 'lessThanOrEqual', 'days' => isset($fields['days']) ? (int)$fields['days'] : '');
                break;
            case 'between':
                $fields['accessHireDate'] = array('hireDateType' => 'between', 'hireStartDate' => isset($fields['hireStartDate']) ? $fields['hireStartDate'] : '', 'hireEndDate' => isset($fields['hireEndDate']) ? $fields['hireEndDate'] : '');
                break;
            case 'before':
                $fields['accessHireDate'] = array('hireDateType' => 'before', 'date' => isset($fields['date']) ? $fields['date'] : '');
                break;
            case 'after':
                $fields['accessHireDate'] = array('hireDateType' => 'after', 'date' => isset($fields['date']) ? $fields['date'] : '');
                break;
            default:
                $fields['accessHireDate'] = array();
                break;
        }
