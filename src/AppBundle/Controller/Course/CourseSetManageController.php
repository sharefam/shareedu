...
class CourseSetManageController extends BaseController
{
    ...
    public function sidebarAction($courseSetId, $curCourse, $sideNav, $hasCourseManagePermission)
    {
        ...
        return $this->render(
            ...
            array(
                ...
                'hasCourseManagePermission' => $hasCourseManagePermission,
            )
        );
    }
