...
class AbstractCloudAPI
{
    ...
    protected function _request($method, $uri, $params, $headers)
    {
        ...
        $headers[] = 'Auth-Token: '.$this->getAuthToken($url, $params, $method);
    ...
    protected function getAuthToken($url, $params, $method)
    {
        if (!$this->authToken) {
            return $this->_makeAuthToken($url, 'GET' == $method ? array() : $params);
        }
