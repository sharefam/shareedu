...
interface ClassroomService
{
    ...
    /**
     * 是否可参与班级的活动，只有正式学员、讲师、网站管理员才能参与班级的活动，旁听生不能参与活动.
     */
     ...
     * @param $courseId
     *
     * @return mixed array(array('classroomId'=>1))
     */
    ...
    public function countClassroomCourses($conditions);
     ...
     * @return mixed
     */
    public function getClassroomCourseByClassroomIdAndCourseId($classroomId, $courseId);

    public function findClassroomCoursesByClassroomId($classroomId);

    public function findClassroomCoursesByCoursesIds($courseIds);

    public function findClassroomCoursesByCourseSetIds($courseSetIds);
