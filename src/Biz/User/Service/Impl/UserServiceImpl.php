...
class UserServiceImpl extends BaseService implements UserService
{
    ...
    public function register($registration, $registerTypes = array('email'))
    {
        if ($this->isOverMaxUsersNumber()) {
            ...
            throw $this->createServiceException($this->trans('admin.user.auth.message.register_exception', array('%max_users_number%' => $maxNumber)));
        }
    ...
    public function getUserIdsByKeyword($keyword)
    {
        ...
        $userIds = $this->findUserIdsByNickNameOrTrueName($keyword);
