...
class UploadFileDaoImpl extends AdvancedDaoImpl implements UploadFileDao
{
    ...
    public function findAllLeaseCloudFiles()
    {
        $sql = "SELECT id,hashId,globalId,syncId,belongResourceCodes FROM {$this->table()} WHERE storage = 'cloud' and syncId > 0";
