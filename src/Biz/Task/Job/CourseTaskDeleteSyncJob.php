...
class CourseTaskDeleteSyncJob extends AbstractJob
{
    public function execute()
    {
        try {
            ...
            $this->getLogService()->error(AppLoggerConstant::COURSE, 'sync_when_task_delete', 'course.log.task.delete.sync.fail_tips', array('error' => $e->getMessage().':'.$e->getTraceAsString()));
        }
    }
