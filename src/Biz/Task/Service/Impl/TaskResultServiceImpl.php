...
class TaskResultServiceImpl extends BaseService implements TaskResultService
{
    ...
    public function countFinishedCompulsoryTasksByUserIdsAndCourseId($userIds, $courseId)
    {
        return $this->getTaskResultDao()->countFinishedCompulsoryTasksByUserIdsAndCourseId($userIds, $courseId);
    }
