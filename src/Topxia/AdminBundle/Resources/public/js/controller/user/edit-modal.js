define(function(require, exports, module) {
    ...
    exports.run = function() {
        ...
        var validator = new Validator({
            ...
            onFormValidated: function(error, results, $form) {
                ...
                $.post($form.attr('action'), $form.serialize(), function(html) {
                    $modal.modal('hide');
                    Notify.success(Translator.trans('admin.user.update.success'));
                    var $tr = $(html);
                    $('#' + $tr.attr('id')).replaceWith($tr);
                }).error(function(){
                    Notify.danger(Translator.trans('admin.user.update.error'));
                });
            }
        });
        ...
        validator.addItem({
            element: '[name="weibo"]',
            rule: 'url',
            errormessageUrl: Translator.trans('admin.user.edit.weibo.message')
        });

        validator.addItem({
            element: '[name="site"]',
            rule: 'url',
            errormessageUrl: Translator.trans('admin.user.edit.site.message')
        });
