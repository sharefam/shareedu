    ...
    exports.run = function() {
        ...
        uploader.on('uploadSuccess', function(file, response ) {
            ...
            $.post(url, response ,function(data){
                ...
                Notify.success(Translator.trans('admin.setting.consult_setting.webchat_url'));
            });    
        });
        ...
        $('[data-role=item-add]').on('click',function(){
            ...
            if( nextIndex > 9 ) {
                Notify.danger(Translator.trans('admin.setting.consult_setting.max_message'));
                return;
            }
        ...
        $('#consult-webchat-del').on('click',function(){
            if (!confirm(Translator.trans('admin.setting.consult_setting.delete_confirm_message'))) return false;
