    ...
    exports.run = function() {
        ...
        uploader1.on('uploadSuccess', function(file, response ) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.operation.banner_setting_success',{num:1}));
          });
        ...
        $("#mobile-banner1-remove").on('click', function(){
            if (!confirm(Translator.trans('admin.operation.banner.delete_confirm_message'))) return false;
            var $btn = $(this);
            $.post($btn.data('url'), function(){
                ...
                Notify.success(Translator.trans('admin.operation.banner.delete_success',{num:1}));
            }).error(function(){
                Notify.danger(Translator.trans('admin.operation.banner.delete_error',{num:1}));
            });
        });
        ...
        uploader2.on('uploadSuccess', function(file, response ) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.operation.banner_setting_success',{num:2}));
          })
        ...
        $("#mobile-banner2-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                Notify.success(Translator.trans('admin.operation.banner.delete_success',{num:2}));
            }).error(function(){
                Notify.danger(Translator.trans('admin.operation.banner.delete_error',{num:2}));
            });
        });
        ...
        uploader3.on('uploadSuccess', function(file, response ) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.operation.banner_setting_success',{num:3}));
          })
        ...
        $("#mobile-banner3-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                Notify.success(Translator.trans('admin.operation.banner.delete_success',{num:3}));
            }).error(function(){
                Notify.danger(Translator.trans('admin.operation.banner.delete_error',{num:3}));
            });
        });
        ...
        uploader4.on('uploadSuccess', function(file, response ) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.operation.banner_setting_success',{num:4}));
          })
        ...
        $("#mobile-banner4-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                Notify.success(Translator.trans('admin.operation.banner.delete_success',{num:4}));
            }).error(function(){
                Notify.danger(Translator.trans('admin.operation.banner.delete_error',{num:4}));
            });
        });
        ...
        uploader5.on('uploadSuccess', function(file, response ) {
          ...
          $.post(url, response, function (data) {
            ...
            Notify.success(Translator.trans('admin.operation.banner_setting_success',{num:5}));
          })
        });
        ...
        $("#mobile-banner5-remove").on('click', function(){
            ...
            $.post($btn.data('url'), function(){
                ...
                Notify.success(Translator.trans('admin.operation.banner.delete_success',{num:5}));
            }).error(function(){
                Notify.danger(Translator.trans('admin.operation.banner.delete_error',{num:5}));
            });
        });
