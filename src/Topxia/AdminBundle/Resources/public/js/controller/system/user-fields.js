define(function(require, exports, module) {
    ...
    exports.run = function() {
        ...
        var titleArr = [Translator.trans('admin.system.user_fields.turename'),Translator.trans('admin.system.user_fields.phone'),Translator.trans('QQ'),Translator.trans('admin.system.user_fields.company'),Translator.trans('admin.system.user_fields.idcard'),Translator.trans('admin.system.user_fields.gender'),Translator.trans('admin.system.user_fields.job'),Translator.trans('admin.system.user_fields.weibo'),Translator.trans('admin.system.user_fields.wechat')];
        $('#add-btn').on('click', function() {
            var field_title = $('input[name="field_title"]').val();
            
            if($.inArray(field_title, titleArr) >= 0 )
            {
                Notify.danger(Translator.trans('admin.system.user_fields.add_error'))
                return false;
            }
        });
        ...
        validator.addItem({
            ...
            required: true,
            errormessageRequired: Translator.trans('admin.system.user_fields.field_type')
        });
